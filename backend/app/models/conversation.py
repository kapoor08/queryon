from sqlalchemy import Column, String, Text, Integer, Float, ForeignKey, Index, Enum, JSON
...
class Conversation(BaseModel):
    ...
    session_id = Column(String(100), nullable=False, index=True)  # Frontend-generated session ID
