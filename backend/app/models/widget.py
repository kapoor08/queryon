from sqlalchemy import Column, String, Text, Boolean, Integer, JSON, Float, ForeignKey, func, Enum, DateTime
...
class Widget(BaseModel):
    ...
    # Training Status
    training_status = Column(Enum(TrainingStatus), default=TrainingStatus.NOT_STARTED, index=True)
    total_documents = Column(Integer, default=0)
    total_chunks = Column(Integer, default=0)
    last_training_date = Column(DateTime(timezone=True))
    
    # AI Configuration
    system_prompt = Column(Text, default="You are a helpful product assistant. Answer questions based on the provided context.")
    ...
    welcome_message = Column(Text, default="Hello! How can I help you with our product?")
    placeholder_text = Column(String(200), default="Ask me anything about our product...")
    ...
    training_documents = relationship("TrainingDocument", back_populates="widget", cascade="all, delete-orphan")
